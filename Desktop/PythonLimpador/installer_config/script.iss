...
#define MyAppName "Limpador"
#define MyAppVersion "0.0.6"
#define MyAppPublisher "Luiz Felipe"
#define MyAppURL "https://github.com/Louiz0"
#define MyAppExeName "app.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{288B21D5-8147-420C-9369-F15BAF32D5C9}
AppName={#MyAppName}
...
[Files]
Source: "C:\Users\felip\Desktop\Git\pythonLimpador\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
