...
def timed_folder_cleanup(number):
    ...
    converted_days = time.mktime(selected_days.timetuple())  # timestamp
...
def windows_cache_cleanup():
    ...
    messagebox.showinfo("Operação concluída", "Limpeza concluída.\
        Alguns arquivos não foram removidos pois estão em uso ou protegidos.")
